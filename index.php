...
<header>
        ...
        <nav class="menu">
            ...
            <ul>
                ...
                <li class="menu__createbtn"><a href="./src/php/add_agenda" target="self"><i class="fas fa-plus"></i> Criar Projeto</a></li>
            </ul>
        </nav>
        ...
        <div class="user">
            <?php
                    ...
                    echo "<a href='./src/php/cadastro' target='self' class='perfil_img'>
                    <i class='fas fa-user'></i>
                 </a>";
                   }else{
                    echo "<a href='./src/php/perfil' target='self' class='perfil_img'>
                    <i class='fas fa-user'></i>
                 </a>";
                   }
            ?>
            ...
            <h3 class="username"><?php 
                if(!isset($_SESSION["username"])){
                    echo "<a href='./src/php/cadastro' target='self' >
                    "."Logar"."
                 </a>";
                    ...
                    echo "<a href='./src/php/perfil' target='self'>
                    ".$_SESSION["username"]."
                 </a>";
...
<div class="container_index">
  ...
  <div class="btn-primary"><a href="./src/php/add_agenda" target="_self"><i class="fas fa-plus"></i> Criar Projeto</a></div>
</div>
