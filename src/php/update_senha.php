    ...
    ?>
        ...
        <div id="login-register-page">
            ...
            <div id="align-form">
                ...
                <form id="table-register" action="./update_senha.php" method="post">
                    <!-- abrindo formulário -->
                    ...
                    <table>
                        ...
                        <tbody id="register-container">
                            ...
                            <tr>
                                <!-- abrindo a linha da tabela -->

                                <td>
                                    <!-- abrindo cedula da tabela -->
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label for="teste" class="form_btn btn_reg">
                                        <!-- container para o botão linkado com o input submit -->
