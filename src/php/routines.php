...
<body>
   ...
   <div id="routines-dashboard">
        <div id="routines-menu"><!-- abrindo container -->
            <h2>Suas rotinas</h2><!-- titulo da página sendo exibido dentro do container -->
        </div><!-- fechando container -->

        <div id="routines-container"><!-- abrindo container dos projetos -->

            <div id="create-routine" class="routine"><!-- abrindo container do botão para criar os projetos, ou os botão para abrir o modal -->
    ...
    <section class="lightbox"><!-- abrindo container da lightbox onde ficará o modal -->
        <div class="modal"><!--abrindo container do modal -->
            <form method="POST" action="" id="criar-proj" class="routines" ><!-- formulário de envio para o usuário -->
                <div class="modal-header"><!-- abrindo cabeçalho do modal -->
                ...
                <div class="modal-inputs"><!-- abrindo configurações do modal -->
