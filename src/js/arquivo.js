$(document).ready(function(){//iniciando as funções com Jquery
    ...
    $("#create-routine").click(function(){
        ...
        //fechar modal, ao pressionar o botão btn-close-modal, remove a classe active do modal e do overlay
    ...
    //fechar modal_color, ao pressionar o botão btn-close-modal, remove a classe active do modal_color e do overlay
